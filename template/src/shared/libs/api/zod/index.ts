...
export const postParsed = async <S extends z.ZodTypeAny>(
	...
	try {
		const response = await SquareAxios.post<unknown>(url, body, config);
		return schema.parse(response.data);
	} catch (error) {
		return parseAxiosError(error);
	}
...
export const putParsed = async <S extends z.ZodTypeAny>(
	...
	try {
		const response = await SquareAxios.put<unknown>(url, body, config);
		return schema.parse(response.data);
	} catch (error) {
		return parseAxiosError(error);
	}
...
export const patchParsed = async <S extends z.ZodTypeAny>(
	...
	try {
		const response = await SquareAxios.patch<unknown>(url, body, config);
		return schema.parse(response.data);
	} catch (error) {
		return parseAxiosError(error);
	}
...
export const deleteParsed = async <S extends z.ZodTypeAny>(
	...
	try {
		const response = await SquareAxios.delete<unknown>(url, config);
		return schema.parse(response.data);
	} catch (error) {
		return parseAxiosError(error);
	}
